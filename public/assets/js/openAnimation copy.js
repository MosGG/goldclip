...
(function($){
	...
	function drawBrand(){
		...
		var letterB = "M 305 350 L 325 350 L 340 365 v 20 h -35 Z M 310 365 h 25 L 325 355 h -15 Z M 310 380 h 25 v -10 h -25 Z"
	...
	function drawDigital(){
		...
		var ending = s.rect(310,105,190,120,0,0).attr({stroke:"#e9004b",strokeWidth:10,opacity:0,fill:"none"})
	...
	function drawHeart(){
		...
		var heart = s.path("M 415 130 L 445 100 L 485 100 L 525 140 v 40 L 415 290 L 300 180 v -40 L 340 100 h 40 Z").attr({ fill: "none", stroke: "red", opacity: "0" });
		...
		Snap.animate(0, loopLength,
		    ...
		    function(){ //callback
		    	...
		    	heartOutline.animate({fillOpacity:"1"},1000,function(){
		    		$("#test-animation").addClass('tower-viewpoint')
		    		drawBrand();
		    	});
		    }//callback
	    );//Snap.animate
	...
	function showDescriptionDesign(){
		homeDescriptionStr = '<h1>Creativity make us pasionate about DESIGN</h1>';
