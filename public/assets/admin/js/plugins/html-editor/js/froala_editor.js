...
(function (factory) {
  ...
  $.FE.MODULES.commands = function (editor) {
    ...
    function _saveFontSize() {
      // Check if the el has fonts size.
      ...
      editor.$el.find('[style]').each (function () {
        ...
        if (hasFontSizeSet($el)) {
          $el.attr('data-fonts-size', $el.css('font-size'));
          $el.css('font-size', '');
        }
      })
    }
    ...
    function _restoreFontSize() {
      editor.$el.find('[data-fonts-size]').each (function () {
        var $el = $(this);

        $el.css('font-size', $el.attr('data-fonts-size'));
        $el.removeAttr('data-fonts-size');
      })
    }
