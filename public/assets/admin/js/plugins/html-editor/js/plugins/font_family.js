...
(function (factory) {
  ...
  // Register the fonts size command.
  $.FE.RegisterCommand('fontFamily', {
    ...
    html: function () {
      ...
      for (var val in options) {
        c += '<li><a class="fr-command" data-cmd="fontFamily" data-param1="' + val + '" style="fonts-family: ' + val + '" title="' + options[val] + '">' + options[val] + '</a></li>';
      }
      c += '</ul>';
