...
(function (factory) {
  ...
  $.FE.PLUGINS.emoticons = function (editor) {
    ...
    function _emoticonsHTML () {
      ...
      if (editor.opts.emoticonsUseImage) emoticons_html += '<p style="fonts-size: 12px; text-align: center; padding: 0 5px;">Emoji free by <a href="http://emojione.com/" target="_blank" rel="nofollow">Emoji One</a></p>';
      emoticons_html += '</div>';
